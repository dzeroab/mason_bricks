...
part '{{mame.snakeCase()}}_view_model.freezed.dart';

final {{mame.camelCase()}}ViewModel = StateNotifierProvider.autoDispose<{{name.pascalCase()}}ViewModel, {{name.pascalCase()}}UiState>((ref) => inject());
